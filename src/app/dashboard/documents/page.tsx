    ...
    <div className="max-w-3xl mx-auto">
      ...
      <div className="relative mb-5">
        ...
        <input
          ...
          className="w-full pl-9 pr-4 py-2.5 text-sm outline-none rounded-xl transition-colors"
          style={{
            background: '#FFFFFF',
      ...
      >
        ...
        >
          <FolderOpen className="w-6 h-6" style={{ color: '#A09890' }} />
        </div>
        <p className="text-sm font-semibold mb-1" style={{ color: '#0F0E0C' }}>Nog geen documenten</p>
        <p className="text-xs" style={{ color: '#A09890' }}>Upload bestanden of maak mappen aan per klant</p>
      </div>
    </div>
  )
}
